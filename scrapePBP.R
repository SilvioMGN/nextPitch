# Function to retrieve Pitch-by-pitch data from Bill Petti (https://billpetti.github.io/2021-04-02-build-statcast-database-rstats-version-3.0/)
...
# Year can be changed here

args <- as.integer(args)

data <- annual_statcast_query(args)


fileName <- paste('pbpData-', toString(args), '.csv', sep="")
